function [sweeps ind] = filtsweeps(sweeps,bOR,varargin)
...
if ~isempty(sweeps)
    ...
    if isfield(sweeps,'trialindices')
        ind = sweeps.trialindices ;
        sweeps.trialindices = [1:length(sweeps.trialindices)]';
    else
        ind = [];
    end
end
